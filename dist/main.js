var C=Object.create;var y=Object.defineProperty;var P=Object.getOwnPropertyDescriptor;var j=Object.getOwnPropertyNames;var R=Object.getPrototypeOf,S=Object.prototype.hasOwnProperty;var v=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports);var b=(e,t,p,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let r of j(t))!S.call(e,r)&&r!==p&&y(e,r,{get:()=>t[r],enumerable:!(n=P(t,r))||n.enumerable});return e};var A=(e,t,p)=>(p=e!=null?C(R(e)):{},b(t||!e||!e.__esModule?y(p,"default",{value:e,enumerable:!0}):p,e));var u=v((k,m)=>{"use strict";var F=["accept","acceptCharset","accessKey","action","allowFullScreen","allowTransparency","alt","async","autoComplete","autoFocus","autoPlay","capture","cellPadding","cellSpacing","charSet","challenge","checked","classID","className","cols","colSpan","content","contentEditable","contextMenu","controls","coords","crossOrigin","data","dateTime","defer","dir","disabled","download","draggable","encType","form","formAction","formEncType","formMethod","formNoValidate","formTarget","frameBorder","headers","height","hidden","high","href","hrefLang","htmlFor","httpEquiv","icon","id","inputMode","keyParams","keyType","label","lang","list","loop","low","manifest","marginHeight","marginWidth","max","maxLength","media","mediaGroup","method","min","minLength","multiple","muted","name","noValidate","open","optimum","pattern","placeholder","poster","preload","radioGroup","readOnly","rel","required","role","rows","rowSpan","sandbox","scope","scoped","scrolling","seamless","selected","shape","size","sizes","span","spellCheck","src","srcDoc","srcSet","start","step","style","summary","tabIndex","target","title","type","useMap","value","width","wmode","wrap"];function w(e){var t=document.createElement("div");return t.innerHTML=e,t.children.length>1&&(e="<div>"+e+"</div>"),e=e.replace(/\sclass=/g," className=").replace(/\sfor=/g," htmlFor=").replace(/<!--/g,"{/*").replace(/-->/g,"*/}"),["area","base","br","col","command","embed","hr","img","input","keygen","link","meta","param","source","track","wbr"].forEach(function(p){var n=new RegExp("<("+p+"[^/]*?)>","g");e=e.replace(n,function(r,c){return"<"+c+"/>"})}),F.forEach(function(p){var n=p.toLowerCase(),r=new RegExp("\\s"+n+"=","g");e=e.replace(r," "+p+"=")}),e=e.replace(/\sstyle="(.+?)"/g,function(p,n){var r=new l(n).toJSXString();return" style={{"+r+"}}"}),e}m.exports=w;function N(e){return e.replace(/-(.)/g,function(t,p){return p.toUpperCase()})}function M(e){return e!=null&&(typeof e=="number"||parseInt(e,10)==e)}var l=function(e){this.parse(e)};l.prototype={parse:function(e){this.styles={},e.split(";").forEach(function(t){t=t.trim();var p=t.indexOf(":"),n=t.substr(0,p),r=t.substr(p+1).trim();n!==""&&(this.styles[n]=r)},this)},toJSXString:function(){var e=[];for(var t in this.styles)this.styles.hasOwnProperty(t)&&e.push(this.toJSXKey(t)+": "+this.toJSXValue(this.styles[t]));return e.join(", ")},toJSXKey:function(e){return N(e)},toJSXValue:function(e){return M(e)?e:"'"+e.replace(/'/g,'"')+"'"}}});var i={id:"bajrangcoder.react.snippets",name:"Acode ES7+ React/Redux snippets",main:"dist/main.js",version:"1.0.1",readme:"readme.md",icon:"icon.png",files:[],minVersionCode:290,price:0,author:{name:"Raunak Raj",email:"bajrangcoders@gmail.com",url:"https://github.com/bajrangCoder/acode-react-snippets",github:"bajrangCoder"}};var T=A(u());function $(e){let p=e.getMode().$id.split("/");return p[p.length-1]}function h(e){let t;return t=(0,T.default)(e),t}var E=[{prefix:"rcc",snippet:`import React, { Component } from 'react'
...
const styles = StyleSheet.create({});`,type:"typescriptReactNativeArrowFunctionComponentWithStyles",description:"Creates a React Native Arrow Function Component with ES7 module system, TypeScript interface and StyleSheet",fileTypes:["jsx","tsx"]}];var{snippetManager:L}=ace.require("ace/snippets"),_=acode.require("selectionMenu"),{editor:o}=editorManager,a=class{constructor(){this.setVariables(),this.initializeAutocompletion(E||[])}setVariables(){let{variables:t}=L;t.FILE_NAME=()=>{let p=editorManager.activeFile.filename,n=p.lastIndexOf(".");return p.slice(0,n)}}initializeAutocompletion(t){this.reactCompleter={getCompletions:(p,n,r,c,f)=>{let g=$(n),d=t.filter(s=>s.fileTypes.includes(g));d.length>0?f(null,d.map(s=>{let x={caption:s.prefix,snippet:s.snippet,meta:s.type,value:s.snippet,type:"snippet",docHTML:s.description||""};return typeof extraSyntaxHighlightsInstalled<"u"&&extraSyntaxHighlightsInstalled?{...x,icon:"icon react-snippet-icon"}:x})):f(null,[])}},o.completers.unshift(this.reactCompleter)}async init(t,p,n){acode.addIcon("react-snippet-icon",this.baseUrl+"icon.png"),_.add(this.convertToJsx.bind(this),"JSX","selected")}convertToJsx(){let t=o.getSelectionRange(),p=o.getSelectedText(),n=h(p);o.getSession().replace(t,n),window.toast("Converted \u{1F4A5}",3e3)}async destroy(){o.completers.splice(o.completers.indexOf(this.reactCompleter),1)}};if(window.acode){let e=new a;acode.setPluginInit(i.id,async(t,p,{cacheFileUrl:n,cacheFile:r})=>{t.endsWith("/")||(t+="/"),e.baseUrl=t,await e.init(p,r,n)}),acode.setPluginUnmount(i.id,()=>{e.destroy()})}
