var v=Object.create;var x=Object.defineProperty;var E=Object.getOwnPropertyDescriptor;var C=Object.getOwnPropertyNames;var P=Object.getPrototypeOf,R=Object.prototype.hasOwnProperty;var S=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports);var b=(e,t,s,r)=>{if(t&&typeof t=="object"||typeof t=="function")for(let p of C(t))!R.call(e,p)&&p!==s&&x(e,p,{get:()=>t[p],enumerable:!(r=E(t,p))||r.enumerable});return e};var A=(e,t,s)=>(s=e!=null?v(P(e)):{},b(t||!e||!e.__esModule?x(s,"default",{value:e,enumerable:!0}):s,e));var u=S((q,m)=>{"use strict";var N=["accept","acceptCharset","accessKey","action","allowFullScreen","allowTransparency","alt","async","autoComplete","autoFocus","autoPlay","capture","cellPadding","cellSpacing","charSet","challenge","checked","classID","className","cols","colSpan","content","contentEditable","contextMenu","controls","coords","crossOrigin","data","dateTime","defer","dir","disabled","download","draggable","encType","form","formAction","formEncType","formMethod","formNoValidate","formTarget","frameBorder","headers","height","hidden","high","href","hrefLang","htmlFor","httpEquiv","icon","id","inputMode","keyParams","keyType","label","lang","list","loop","low","manifest","marginHeight","marginWidth","max","maxLength","media","mediaGroup","method","min","minLength","multiple","muted","name","noValidate","open","optimum","pattern","placeholder","poster","preload","radioGroup","readOnly","rel","required","role","rows","rowSpan","sandbox","scope","scoped","scrolling","seamless","selected","shape","size","sizes","span","spellCheck","src","srcDoc","srcSet","start","step","style","summary","tabIndex","target","title","type","useMap","value","width","wmode","wrap"];function I(e){var t=document.createElement("div");return t.innerHTML=e,t.children.length>1&&(e="<div>"+e+"</div>"),e=e.replace(/\sclass=/g," className=").replace(/\sfor=/g," htmlFor=").replace(/<!--/g,"{/*").replace(/-->/g,"*/}"),["area","base","br","col","command","embed","hr","img","input","keygen","link","meta","param","source","track","wbr"].forEach(function(s){var r=new RegExp("<("+s+"[^/]*?)>","g");e=e.replace(r,function(p,c){return"<"+c+"/>"})}),N.forEach(function(s){var r=s.toLowerCase(),p=new RegExp("\\s"+r+"=","g");e=e.replace(p," "+s+"=")}),e=e.replace(/\sstyle="(.+?)"/g,function(s,r){var p=new y(r).toJSXString();return" style={{"+p+"}}"}),e}m.exports=I;function F(e){return e.replace(/-(.)/g,function(t,s){return s.toUpperCase()})}function M(e){return e!=null&&(typeof e=="number"||parseInt(e,10)==e)}var y=function(e){this.parse(e)};y.prototype={parse:function(e){this.styles={},e.split(";").forEach(function(t){t=t.trim();var s=t.indexOf(":"),r=t.substr(0,s),p=t.substr(s+1).trim();r!==""&&(this.styles[r]=p)},this)},toJSXString:function(){var e=[];for(var t in this.styles)this.styles.hasOwnProperty(t)&&e.push(this.toJSXKey(t)+": "+this.toJSXValue(this.styles[t]));return e.join(", ")},toJSXKey:function(e){return F(e)},toJSXValue:function(e){return M(e)?e:"'"+e.replace(/'/g,'"')+"'"}}});var o={id:"bajrangcoder.react.snippets",name:"Acode ES7+ React/Redux snippets",main:"dist/main.js",version:"1.0.1",readme:"readme.md",icon:"icon.png",files:[],minVersionCode:290,price:0,author:{name:"Raunak Raj",email:"bajrangcoders@gmail.com",url:"https://github.com/bajrangCoder/acode-react-snippets",github:"bajrangCoder"}};var $=A(u());function T(e){let s=e.getMode().$id.split("/");return s[s.length-1]}function h(e){let t;return t=(0,$.default)(e),t}var j=[{prefix:"rcc",snippet:`import React, { Component } from 'react'
